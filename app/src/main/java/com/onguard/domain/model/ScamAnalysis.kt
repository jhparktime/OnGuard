...
data class ScamAnalysis(
    ...
    val highRiskKeywords: List<String> = emptyList(),
    val mediumRiskKeywords: List<String> = emptyList(),
    val lowRiskKeywords: List<String> = emptyList(),
    val hasSuspiciousCombination: Boolean = false,
